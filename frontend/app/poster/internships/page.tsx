    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <nav className="bg-blue-900 text-white py-3 shadow">
        <div className="max-w-5xl mx-auto flex justify-center space-x-6 text-sm font-medium">
          <Link href="/poster/community" className="hover:text-yellow-300 transition-colors">
            Student Community
          </Link>
          <Link href="/poster/ra" className="hover:text-yellow-300 transition-colors">
            Research Positions
          </Link>
          <Link href="/poster/internships" className="hover:text-yellow-300 transition-colors font-semibold underline underline-offset-4">
            Entrepreneur Openings
          </Link>
          <Link href="/poster/hatchery" className="hover:text-yellow-300 transition-colors">
            Hatchery Openings
          </Link>
        </div>
      </nav>
      ...
      <main className="flex-grow px-4 py-10 bg-white">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          {posts.map((post, index) => {
            ...
            return (
              <Link key={post._id} href={`/poster/internships/event/${post._id}`}>
                <div
